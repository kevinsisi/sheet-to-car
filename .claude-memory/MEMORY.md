...
| Chat routing hardening | The chat agent now deterministically routes clear direct-generation, owner-check, and readiness intents for supported phrases, while avoiding unsupported platforms, extra one-off copy constraints, broad follow-up confirmations, and malformed all-platform formatting |
